                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end pe-4">
                                                <button class="btn btn-sm btn-outline-primary shadow-sm"
                                                    data-bs-toggle="modal" data-bs-target="#editModal{{ $k->id_kategori }}"
                                                    title="Edit Kategori">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-outline-danger shadow-sm ms-1"
                                                    onclick="confirmDelete('/admin/kategori/{{ $k->id_kategori }}/delete', 'Hapus kategori ini? Data yang terkait bisa saja hilang.')"
                    ...
                    <form action="/admin/kategori/{{ $k->id_kategori }}/update" method="POST">
                        ...
                        <div class="modal-body py-4">
                            <div class="mb-2">
                                ...
                                <input type="text" name="nama_kategori" class="form-control form-control-lg fs-6"
