        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-4 font-monospace small">{{ date('d/m/Y H:i', strtotime($a->tanggal_input)) }}</td>
                        <td>{{ $a->nisn }}</td>
                        <td>{{ $a->nama }}</td>
                        ...
                        <td class="text-end pe-4">
                            <a href="/admin/aspirasi/{{ $a->id_aspirasi }}" class="btn btn-sm btn-light">Buka</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">Tidak ada data aspirasi ditemukan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
