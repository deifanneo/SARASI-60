                            ...
                            <div class="mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    @if ($a->status == 'Diajukan')
                                        <a href="/siswa/aspirasi/{{ $a->id_aspirasi }}/edit"
                                            class="btn btn-sm btn-outline-primary shadow-sm px-3 me-1" title="Edit"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <button type="button"
                                            onclick="confirmDelete('/siswa/aspirasi/{{ $a->id_aspirasi }}/delete', 'Hapus aspirasi ini? Tidak dapat dikembalikan.')"
                                            class="btn btn-sm btn-outline-danger shadow-sm px-3 me-1" title="Hapus"><i
                                                class="bi bi-trash-fill"></i></button>
                                    @endif
                                    <a href="/siswa/aspirasi/{{ $a->id_aspirasi }}"
